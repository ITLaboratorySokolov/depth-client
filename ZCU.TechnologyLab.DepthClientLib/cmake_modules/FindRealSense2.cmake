...
if(CMAKE_CL_64)
find_library(RealSense2_LIBRARY NAMES realsense2 PATHS ${RealSense2_ROOT_DIR}/lib ${RealSense2_ROOT_DIR}/lib/x64  ${RealSense2_ROOT_DIR}/bin ${RealSense2_ROOT_DIR}/bin/x64)
else()
find_library(RealSense2_LIBRARY NAMES realsense2 PATHS ${RealSense2_ROOT_DIR}/lib ${RealSense2_ROOT_DIR}/lib/x86  ${RealSense2_ROOT_DIR}/bin ${RealSense2_ROOT_DIR}/bin/x86)
endif()
